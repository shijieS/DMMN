...
frame_index = 0
for frames_1, bboxes_1, motion_parameters_1, motion_possibility_1, times_1,\
    ...
    for i, (frame, bboxes, new_bboxes, time) in enumerate(zip(frames_1, bboxes_1, new_bboxes_1, times_1)):
        frame_left += [
            show_bboxes(show_bboxes(frame, bboxes, color=(255, 0, 0), titles=titles_1, time=time),
    ...
    for i, (frame, bboxes, new_bboxes, time) in enumerate(zip(frames_2, bboxes_2, new_bboxes_2, times_2)):
        frame_right += [show_bboxes(show_bboxes(frame, bboxes, color=(255, 0, 0), titles=titles_2, time=time),
                        new_bboxes, color=(255, 255, 255))
                        ]
