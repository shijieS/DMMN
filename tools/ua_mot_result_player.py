...
parser.add_argument('--mot_result_folder', default='/media/ssm/data/dataset/uadetrac/test_logs/mot', help='the image folder')
...
def play(mot_folder, image_folder):
    ...
    for s in sequence_name:
        ...
        for frame_index in frame_index_list:
            ...
            colors = [DrawBoxes.get_random_color(i) for i in ids]
